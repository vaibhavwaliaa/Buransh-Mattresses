    ...
    <div className="flex-shrink-0 w-64 sm:w-72 md:w-80 h-[380px] sm:h-96 bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-shadow duration-300 overflow-hidden border border-gray-100 flex flex-col">
      ...
      <div className="flex-1 p-4 sm:p-6 flex flex-col justify-between">
        <div>
          ...
          <p className="text-xs sm:text-sm text-gray-600 leading-relaxed font-medium tracking-wide line-clamp-3">{description}</p>
        </div>
        
        {/* Button */}
        <button
          onClick={onButtonClick}
          className="w-full py-2.5 sm:py-3 px-4 bg-indigo-600 text-white text-sm sm:text-base font-semibold rounded-lg hover:bg-indigo-700 transition-colors duration-200 focus:outline-none focus:ring-4 focus:ring-indigo-500 focus:ring-opacity-50 transform hover:scale-[1.02] active:scale-[0.98]"
        >
          View Details
        </button>
      </div>
